  ...
  return (
    <div className = "history" ref={history}>
      ...
      <div className="content content-01">
        ...
        <span className="description">Located at the heart of the Korean Peninsula, Seoul has always been an important strategic point throughout the centuries in terms of defense and the economy, from one kingdom to the next. The three kingdoms of Baekje, Goguryeo, and Silla (BCE 57 – CE 688) all fought over the area that is now Korea’s capital. </span>
      </div>
      <div className="content content-02">
        ...
        <div className="left intro">
          ...
          <span className="description">The 2010 G20 Seoul Summit was the fifth meeting of the G20
            heads of government/heads of state, to discuss the global
            financial system and the world economy, which took place
            in Seoul, South Korea, on November 11–12, 2010. South Korea
            was the first non-G8 nation to host a G20 leaders' summit.
          </span>
        </div>
        <div className="right">
      ...
      <div className="content content-03">
        ...
        <div className="intro">
          ...
          <span className="description">Construction had been delayed by four months due to
            harsh weather conditions in Seoul. On 17 February 2013,
            the gate was 96% completed, and all steel-frame
            scaffolding had been removed. It was officially
            reopened on 5 May 2013.
          </span>
        </div>
      </div>
      <div className="content content-04">
          ...
          <div className="container" ref={container}>
            ...
            <span className="description">
              ...
              extreme haste, it is remarkable that the project identified practical scope
              of work in the complicated downtown area and completed it in a short
              span of time and in an efficient manner that minimized inconvenience. 
              <br/><br/>
              The new Cheonggyecheon was not simply a restoration, but a re-creation.
              It was basically about demolishing the coverage and elevated highway
              and creating a pedestrian-oriented and eco-friendly stream. Triggered
              by the re-creation of such a public space, the revitalization of the
              urban area is still going on today. 
            </span>
          </div>
